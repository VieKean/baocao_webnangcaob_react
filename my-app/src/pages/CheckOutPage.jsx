...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare order data
      const orderData = {
        customer_id: localStorage.getItem('customerId'), // Assumed you store customer ID after login
        order_date: new Date(),
      ...
      if (response.data.success) {
        ...
        await axios.post('/api/orderstatushistory/create', {
        ...
        await axios.delete(`/api/cart/clear/${localStorage.getItem('customerId')}`);
        ...
        <div className="col-md-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group mb-3">
              ...
              {error.provinces && <div className="text-danger mt-1">{error.provinces}</div>}
            </div>
            <div className="form-group mb-3">
              ...
              {error.districts && <div className="text-danger mt-1">{error.districts}</div>}
            </div>
            <div className="form-group mb-3">
              ...
              {error.wards && <div className="text-danger mt-1">{error.wards}</div>}
            </div>
            <div className="form-group mb-3">
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-header">
              <h3 className="card-title mb-0">Đơn hàng</h3>
            </div>
